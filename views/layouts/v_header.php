...
<main class="d-flex flex-nowrap">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item">
                <a href="<?= base_url('hari-libur.php') ?>"
                   class="nav-link text-white <?= $_SERVER['PHP_SELF'] == "/hari-libur.php" ? 'active' : '' ?>"
                   aria-current="page">
                   <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar2-x me-2" viewBox="0 0 16 16">
